...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            params = {
                "Decision Tree": {
                    'criterion': ['squared_error', 'absolute_error'],  # ✅ FIXED
                    'max_depth': [3, 5, 7, 10],
                    'min_samples_split': [2, 5, 10],
                },
                "Random Forest": {
                    'criterion': ['squared_error', 'absolute_error'],  # ✅ FIXED (if uncommented)
                ...
                "Gradient Boosting": {
                    ...
                    'criterion': ['squared_error', 'friedman_mse'],  # ✅ Both are valid for GB
                    'n_estimators': [8, 16, 32, 64, 128, 256],
                },
                "Linear Regression": {},  # ✅ Fine
                "XGBRegressor": {
                    'learning_rate': [0.1, 0.01, 0.05, 0.001],
                    'n_estimators': [8, 16, 32, 64, 128, 256],
                    'max_depth': [3, 5, 7],
